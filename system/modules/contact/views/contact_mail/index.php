				...
				<tr>
					...
					<td>
                        <?php 
    						...
    						echo ( strlen($message) > 150 ) ? substr($message,0,148) . '..' : $message;                        
    					?>
                    </td>		
					...
					<td class="actions">
    					...
    					<?php /*
    						echo anchor(SITE_AREA . '/content/contact/contact_mail/edit/' . $record->id, 
    					...
    					<?php 
    						echo anchor(SITE_AREA . '/content/contact/contact_mail/detail/' . $record->id, 
    					...
    					<?php 
							echo anchor(SITE_AREA . '/content/contact/contact_mail/delete/' . $record->id, 
