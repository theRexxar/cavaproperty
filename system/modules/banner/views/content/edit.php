...
<div class="admin-box">
    ...
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="submit" class="btn btn-primary" value="Edit Banner" />
    ...
    <?php if ($this->auth->has_permission('Banner.Content.Delete')) : ?>
            ...
            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/banner/delete/'. $id);?>" onclick="return confirm('<?php echo lang('banner_delete_confirm'); ?>')" name="delete-me">
