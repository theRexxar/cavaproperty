...
class Files extends Front_Controller
{
	...
	{	
		...
		$this->_thumb_path 	= FCPATH . $this->config->item('files_folder_thumb');
	}
	...
	public function download($id = 0)
	{
		...
		$file = $this->file_model->find($id) OR show_404();
	...
	public function thumb($id = 0, $width = 100, $height = 100, $mode = NULL)
	{
		...
		$image_thumb = $this->_thumb_path . ($mode ? $mode : 'normal');
		...
		$expire = 60 * 60; // 1 hour
		if ($expire && $this->input->get('cache') != 'clear')
		{
