...
<div class="admin-box">
    ...
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Edit Career" />
    ...
    <?php if ($this->auth->has_permission('Career.Content.Delete')) : ?>
            ...
            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('career_delete_confirm'); ?>')">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('career_delete_record'); ?>
            </button>
