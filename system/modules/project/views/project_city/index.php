		...
		<table class="table table-striped">
			...
			<?php foreach ($records as $record) : ?>
				<tr>
				    ...
				    <td><?php echo $record->title_location?></td>
                    ...
                    <td class="actions">
    					...
    					<?php 
    						echo anchor(SITE_AREA . '/content/project/project_city/edit/' . $record->id, 
    					...
    					<?php 
							echo anchor(SITE_AREA . '/content/project/project_city/delete/' . $record->id, 
